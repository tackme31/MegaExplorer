...
- `docs/DESIGN_IMPROVEMENT.md` — the UI-tidying pass: measured findings, the D*/S* decision tables,
  and the per-stage log for S0–S11 (S0–S5 done). Visual work goes here, not in `docs/PROGRESS.md`;
  the two C++ changes it caused are cross-linked from both.
...
the UI-polish pass (S0–S5, `docs/DESIGN_IMPROVEMENT.md`) introduced — and cross-cutting app
