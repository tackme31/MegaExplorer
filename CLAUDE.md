...
- `docs/DESIGN_IMPROVEMENT.md` — the UI-tidying pass: measured findings, the D*/S* decision tables,
  and the per-stage log for S0–S11 (S0–S7 done). Visual work goes here, not in `docs/PROGRESS.md`;
...
the UI-polish pass (S0–S7, `docs/DESIGN_IMPROVEMENT.md`) introduced — and cross-cutting app
