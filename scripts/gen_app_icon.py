...
the caption row and Alt-Tab ask for at 100-200% scaling, 64 covers 400%, and
256 is the one Explorer's extra-large view uses (stored PNG-compressed inside
the .ico, which Pillow does on its own above 64px).
"""
